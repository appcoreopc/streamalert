...
import backoff
import boto3
from botocore.exceptions import ClientError, ReadTimeoutError, ConnectTimeoutError, ConnectionError
...
class FirehoseClient(object):
    ...
    EXCEPTIONS_TO_BACKOFF = (ClientError, ConnectionError, ReadTimeoutError, ConnectTimeoutError)
